...
urlpatterns = [
    ...
    path('cur_community/<str:community_id>/suggestion/<int:sugg_id>/upvote/', views.upvote),
    path('cur_community/<str:community_id>/suggestion/<int:sugg_id>/downvote/', views.downvote),
    path('suggestions/', views.suggestions_view),
    path('cur_community/<str:community_id>/comment/<int:sugg_id>/', views.comment_view),
